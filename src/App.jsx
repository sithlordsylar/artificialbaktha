...
1. If the question asks about a **prophecy**:
   - Quote the prophecy exactly as written in the provided text (if found).
   - Then interpret its symbolic and emotional meaning, expanding with metaphor, cosmic allegory, and sacred vision.
...
Additional Reference Context (for external relations; do not quote directly unless it fits symbolically):
"""
${referencesString}
"""

Alternative Name Mappings (for understanding alternate spellings/names):
"""
${altNamesString}
"""

User Question:
"${normalizedQuestionForAI}"

Return your response as a **JSON object** with the structure below, and no extra text outside it:
{
  "matched_answers": ["snippet 1", "snippet 2", ...],
  "exact_answer_text": "Quote or extract the exact relevant section from the lore text if one exists. If it's a prophecy, include it verbatim.",
  "tldr_summary": "Then provide your interpretive explanation or modern reflection, depending on the question type."
}
`;
